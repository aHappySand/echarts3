...
import { extend } from '../../../zrender/core/util';
...
const Symbol = /** @class */ (function (_super) {
  __extends(Symbol, _super);
  function Symbol(data, idx, seriesScope, opts) {
    const ecModel = data.hostModel.ecModel;
    var _this = _super.call(this, { ecModel }) || this;
  ...
  Symbol.prototype._updateCommon = function (data, idx, symbolSize, seriesScope, opts) {
    ...
    var scaleRatio = hoverScale == null || hoverScale === true
  ...
  Symbol.prototype.getColor = function () {
    var symbolPath = this.childAt(0);
    return symbolPath.style.stroke || symbolPath.style.fill;
  };
