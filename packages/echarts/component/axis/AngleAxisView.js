...
const AngleAxisView = /** @class */ (function (_super) {
  ...
  AngleAxisView.prototype.render = function (angleAxisModel, ecModel) {
    ...
    var labels = zrUtil.map(angleAxis.getViewLabels(), (labelItem) => {
      labelItem = zrUtil.clone(labelItem);
      var scale = angleAxis.scale;
      var tickValue = scale.type === 'ordinal'
        ? scale.getRawOrdinalNumber(labelItem.tickValue)
        : labelItem.tickValue;
...
const angelAxisElementsBuilders = {
  ...
  axisTick(group, angleAxisModel, polar, ticksAngles, minorTickAngles, radiusExtent) {
    ...
    var lines = zrUtil.map(ticksAngles, (tickAngleItem) => new graphic.Line({
  ...
  axisLabel(group, angleAxisModel, polar, ticksAngles, minorTickAngles, radiusExtent, labels) {
    ...
    zrUtil.each(labels, (labelItem, idx) => {
