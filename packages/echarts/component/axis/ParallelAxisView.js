...
const ParallelAxisView = /** @class */ (function (_super) {
  ...
  ParallelAxisView.prototype.render = function (axisModel, ecModel, api, payload) {
    ...
    var builderOpt = zrUtil.extend({ strokeContainThreshold: areaWidth }, axisLayout);
  ...
  ParallelAxisView.prototype._onBrush = function (eventParam) {
    ...
    var intervals = zrUtil.map(coverInfoList, (coverInfo) => [
