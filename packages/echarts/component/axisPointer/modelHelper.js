...
* under the License.
*/
import { each, curry, clone, defaults, isArray, indexOf } from '../../../zrender/core/util';
...
function collectAxesInfo(result, ecModel, api) {
  ...
  var linkGroups = [];
  // Collect axes info.
  each(api.getCoordinateSystems(), (coordSys) => {
...
function collectSeriesInfo(result, ecModel) {
  ...
  ecModel.eachSeries((seriesModel) => {
    ...
    each(result.coordSysAxesInfo[makeKey(coordSys.model)], (axisInfo) => {
