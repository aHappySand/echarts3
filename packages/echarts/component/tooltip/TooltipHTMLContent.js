...
* under the License.
*/
import { isString, indexOf, each, bind, isFunction, isArray, isDom } from '../../../zrender/core/util';
import { normalizeEvent } from '../../../zrender/core/event';
import { transformLocalCoord } from '../../../zrender/core/dom';
...
function assembleArrow(tooltipModel, borderColor, arrowPosition) {
  ...
  var arrowOffset = Math.round(((rotatedWH - Math.SQRT2 * borderWidth) / 2 +
...
const TooltipHTMLContent = /** @class */ (function () {
  function TooltipHTMLContent(api, opt) {
    ...
    var container = appendTo && (isString(appendTo)
  ...
  TooltipHTMLContent.prototype.hide = function () {
    ...
    this._show = false;
    this._longHideTimeout = setTimeout(() => _this._longHide = true, 500);
  };
