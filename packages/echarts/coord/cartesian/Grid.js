 ...
 */
import { isObject, each, indexOf, retrieve3, keys } from '../../../zrender/core/util';
...
const Grid = /** @class */ (function () {
  ...
  Grid.prototype.update = function (ecModel, api) {
    ...
    var onZeroRecords = {};
    each(axesMap.x, (xAxis) => {
      fixAxisOnZero(axesMap, 'y', xAxis, onZeroRecords);
    });
    each(axesMap.y, (yAxis) => {
  ...
  Grid.prototype._updateScale = function (ecModel, gridModel) {
    ...
    function unionExtent(data, axis) {
      each(getDataDimensionsOnAxis(data, axis.dim), (dim) => {
  ...
  Grid.prototype.getTooltipAxes = function (dim) {
    var baseAxes = [];
    var otherAxes = [];
    each(this.getCartesians(), (cartesian) => {
  ...
  Grid.create = function (ecModel, api) {
    var grids = [];
    ecModel.eachComponent('grid', (gridModel, idx) => {
