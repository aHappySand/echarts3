...
* under the License.
*/
import { assert, isArray, eqNaN, isFunction } from '../../zrender/core/util';
import { parsePercent } from '../../zrender/contain/text';

const ScaleRawExtentInfo = /** @class */ (function () {
...
const DETERMINED_MIN_MAX_ATTR = { min: '_determinedMin', max: '_determinedMax' };
const DATA_MIN_MAX_ATTR = { min: '_dataMin', max: '_dataMax' };
