...
* under the License.
*/
import { each, map, isFunction, createHashMap, noop, assert } from '../../zrender/core/util';
...
const Scheduler = /** @class */ (function () {
  ...
  Scheduler.prototype.restoreData = function (ecModel, payload) {
    ...
    this._stageTaskMap.each((taskRecord) => {
  ...
  Scheduler.prototype._performStageTasks = function (stageHandlers, ecModel, payload, opt) {
    ...
    var scheduler = this;
    each(stageHandlers, (stageHandler, idx) => {
      ...
      if (overallTask) {
        ...
        seriesTaskMap.each((task, pipelineId) => {
...
function seriesTaskReset(context) {
  ...
  return resetDefines.length > 1
    ? map(resetDefines, (v, idx) => makeSeriesTaskProgress(idx))
