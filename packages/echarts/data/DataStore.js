...
* under the License.
*/
import { assert, clone, createHashMap, isFunction, keys, map, reduce } from '../../zrender/core/util';
 ...
 */
const DataStore = /** @class */ (function () {
  function DataStore() {
    this._chunks = [];
  ...
  DataStore.prototype.getMedian = function (dim) {
    ...
    // TODO
    // Use quick select?
    var sortedDimDataArray = dimDataArray.sort((a, b) => a - b);
    var len = this.count();
    // calculate median
    return len === 0
      ? 0
  ...
  DataStore.prototype.clone = function (clonedDims, ignoreIndices) {
    ...
    var chunks = this._chunks;
    var clonedDimsMap = clonedDims && reduce(clonedDims, (obj, dimIdx) => {
      obj[dimIdx] = true;
      return obj;
    }, {});
    if (clonedDimsMap) {
  ...
  DataStore.internalField = (function () {
    ...
    defaultDimValueGetters = {
      ...
      typedArray(dataItem, property, dataIndex, dimIndex) {
