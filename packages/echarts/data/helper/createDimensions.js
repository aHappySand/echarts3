...
import { createHashMap, defaults, each, extend, isObject, isString } from '../../../zrender/core/util';
...
// TODO: TYPE completeDimensions type
  ...
  encodeDefMap.each((dataDimsRaw, coordDim) => {
    ...
    each(dataDims, (resultDimIdxOrName, idx) => {
  ...
  each(sysDims, (sysDimItemRaw) => {
    ...
    // Apply templates.
    each(dataDims, (resultDimIdx, coordDimIndex) => {
