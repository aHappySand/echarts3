...
* under the License.
*/
import { each, createHashMap, assert, map } from '../../../zrender/core/util';
import { VISUAL_DIMENSIONS } from '../../util/types';

const DimensionUserOuput = /** @class */ (function () {
...
export function summarizeDimensions(data, schema) {
  ...
  each(data.dimensions, (dimName) => {
    ...
    VISUAL_DIMENSIONS.each((v, otherDim) => {
  ...
  notExtraCoordDimMap.each((v, coordDim) => {
