...
import { createHashMap, each, isArray, isString, isObject, isTypedArray } from '../../../zrender/core/util';
import {
...
export function makeSeriesEncodeForAxisCoordSys(coordDimensions, seriesModel, source) {
  ...
  each(coordDimensions, (coordDimInfoLoose, coordDimIdx) => {
  ...
  each(coordDimensions, (coordDimInfo, coordDimIdx) => {
