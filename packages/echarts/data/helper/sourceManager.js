...
* under the License.
*/
import { setAsPrimitive, map, isTypedArray, assert, each, retrieve2 } from '../../../zrender/core/util';
 ...
 * ```
 */
const SourceManager = /** @class */ (function () {
  ...
  SourceManager.prototype._createSource = function () {
    ...
    if (isSeries(sourceHost)) {
      ...
      var needsCreateSource = seriesLayoutBy !== upMetaRawOption.seriesLayoutBy ||
