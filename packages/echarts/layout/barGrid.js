...
* under the License.
*/
import { each, defaults, keys } from '../../zrender/core/util';
...
function doCalBarWidthAndOffset(seriesInfoList) {
  ...
  var columnsMap = {};
  each(seriesInfoList, (seriesInfo, idx) => {
  ...
  var result = {};
  each(columnsMap, (columnsOnAxis, coordSysName) => {
    result[coordSysName] = {};
    var stacks = columnsOnAxis.stacks;
