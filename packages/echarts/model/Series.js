...
const SeriesModel = /** @class */ (function (_super) {
...
function wrapData(data, seriesModel) {
  zrUtil.each(zrUtil.concatArray(data.CHANGABLE_METHODS, data.DOWNSAMPLE_METHODS), (methodName) => {
