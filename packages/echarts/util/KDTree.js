...
const KDTreeNode = /** @class */ (function () {
...
const KDTree = /** @class */ (function () {
  ...
  KDTree.prototype._buildTree = function (points, left, right, axis) {
    ...
    medianIndex = quickSelect(points, left, right, medianIndex, (a, b) => a.array[axis] - b.array[axis]);
