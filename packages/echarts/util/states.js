...
export function allLeaveBlur(api) {
  ...
  model.eachComponent((componentType, componentModel) => {
    var componentStates = getComponentStates(componentModel);
    var isSeries = componentType === 'series';
    var view = isSeries ? api.getViewOfSeriesModel(componentModel)
...
export function handleGlobalMouseOverForHighDown(dispatcher, e, api) {
  ...
  var dispatchers = _a.dispatchers; var
